...
REGISTRY: dict[str, StrategySpec] = {
    ...
    "commodity": StrategySpec("Commodity Supercycle", "configs.sector_commodity", "data.pipelines.sector_commodity", "strategies.sector_commodity.backtest", "_commodity"),
}
