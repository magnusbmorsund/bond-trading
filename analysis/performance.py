...
Metric functions live in analysis.metrics (no matplotlib dependency).
This module re-exports them for backwards compatibility and adds all plots.
"""
import pandas as pd
import numpy as np
...
from analysis.metrics import (  # noqa: F401 — re-exported for callers
    sharpe, max_drawdown, calmar, drawdown_series, summary,
)
