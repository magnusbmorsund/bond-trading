...
def run_optimization(n_trials: int = 300, v2: bool = False, v3: bool = False, sector: bool = False, sector2: bool = False, sector2b: bool = False, sector2c: bool = False, sector2d: bool = False, stop_freq: str = "daily"):
    if sector2:
