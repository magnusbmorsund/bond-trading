"""
V2e sector rotation portfolio builder.

Cluster-capped top-N selection with correlation filter — identical logic to V2d,
uses configs.sector_v2e for parameters.
"""
import logging
import pandas as pd
import numpy as np
