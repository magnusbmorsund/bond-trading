"""V2h portfolio — thin wrapper around strategies.sector_shared.portfolio."""
import configs.sector_v2h as config
from strategies.sector_shared.portfolio import build_weights as _bw, build_weight_series as _bws
