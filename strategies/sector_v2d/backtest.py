"""
V2d sector rotation backtest engine.

V2d extends V2b with:
...
from strategies.sector_v2d.signals   import (
    composite_score, mom_12m, rolling_vol, spy_regime,
    resample_to_period_end, rolling_corr_at_dates,
)
from strategies.sector_v2d.portfolio import build_weight_series
